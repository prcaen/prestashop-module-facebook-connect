...
class FacebookConnect extends Module
{
  ...
  function hookTop($params)
  {
    ...
    $conf = array(
      ...
      'fb_perms'   => (Configuration::get('FB_USER_LOCATION') == 'on' ? 'fb_user_location,' : '') . (Configuration::get('FB_USER_HOMETOWN') == 'on' ? 'fb_user_hometown,' : '') . (Configuration::get('FB_USER_BIRTHDAY') == 'on' ? 'fb_user_birthday' : '')
    );
